    ...
    <div class="container">
        ...
        <div class="titles-container">
            ...
            <div class="section-title">
                ...
                <button type="button" class="add-button" onclick="openAddPerangkatModal()" title="Tambah Perangkat">
            ...
            <div class="section-title">
                ...
                <button type="button" class="add-button" onclick="openAddBrandModal()" title="Tambah Brand">
                    <span class="material-symbols-outlined">add</span>
                </button>
            </div>
        </div>
